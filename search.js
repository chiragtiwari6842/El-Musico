            ...
            <div class="text-left song-container" style="margin-bottom:20px;border-radius:10px;background-color:#1c1c1c;padding:10px;">
                <div class="row" style="margin:auto;">
                    ...
                    <div class="col" style="border-style:none;padding:2px;">
                        ...
                        <button class="btn btn-primary song-btn" type="button" style="margin:0px 2px;" title="Add to Queue" onclick='AddToQueue("${download_url}","${song_id}")'><img src="assets/add-to-queue.png" style="width:25px;height:25px"display:flex;align-items:center;></button>
